...
registrationForm.addEventListener('submit', function(event) {
  ...
  // Yuborish uchun ma'lumotlarni qayta ishlash, saqlash yoki yoritish mumkin

  console.log('Ism:', firstname);
  console.log('Familiya:', lastname);
  console.log('Gmail:', email);
  console.log('Parol:', password);
  console.log('Viloyat:', province);
  console.log('Tuman:', district);
  console.log('Maktab raqami:', school);
